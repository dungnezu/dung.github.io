                ...
                <div class="col-xs-12">
                        ...
                        <form id="formSubmit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="dt_mausac1" name="dt_mausac1" value="${model.dt_mausac1}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>        
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="dt_pin" name="dt_pin" value="${model.dt_pin}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
