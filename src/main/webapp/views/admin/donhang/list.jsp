	...
	<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
		...
		<body>
			<div class="main-content">
				<form action="<c:url value='/admin-donhanglist'/>" id="formSubmit" method="get">
												...
												<table class="table table-bordered">
													...
													<tbody>
														<c:forEach var="item" items="${model.listResult}">
															<tr>
																<td><input type="checkbox" id="checkbox_${item.dh_id}"
																		value="${item.dh_id}"></td>
																<td>${item.dh_id}</td>
																...
																<td>
																	<c:url var="editURL" value="/admin-donhanglist">
